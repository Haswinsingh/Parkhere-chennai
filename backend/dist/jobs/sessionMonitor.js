...
exports.startSessionMonitor = exports.runSessionMonitorJob = void 0;
...
const runSessionMonitorJob = async () => {
    try {
        ...
        for (const booking of warningCandidates) {
            ...
            await booking.save();
            const parkingName = booking.parkingId?.name || 'your parking space';
        ...
        for (const booking of expiredBookings) {
            ...
            await booking.save();
            const parkingName = booking.parkingId?.name || 'parking';
            // Notify driver
            await (0, notificationService_1.sendNotification)({
                userId: booking.userId,
                type: 'parking_ended',
...
exports.runSessionMonitorJob = runSessionMonitorJob;
/**
...
const startSessionMonitor = () => {
    ...
    (0, exports.runSessionMonitorJob)();
    return setInterval(exports.runSessionMonitorJob, 30 * 1000);
};
exports.startSessionMonitor = startSessionMonitor;
